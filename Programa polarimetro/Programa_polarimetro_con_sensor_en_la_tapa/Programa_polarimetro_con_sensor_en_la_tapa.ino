...
ISR (TIMER2_OVF_vect)
{
  ...
  if (flag_tapa == 0 && estado_pantalla == 7)
  {
    estado_pantalla = 14;
    flag_tapa = 0;
    //digitalWrite (ledPin, LOW); LO PUSE EN EL FOR DE SERVO ANTES DE BREAK PARA VER SI AHI FUNCIONA
    //apagoel laser
  }
}
